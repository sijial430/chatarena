...
class TestArena(TestCase):
    def test_arena_1(self):
        ...
        os.system("touch tests/saved_history/nlp-classroom.json")
        os.system("touch tests/saved_config/nlp-classroom.json")
        arena.save_history(path="tests/saved_history/nlp-classroom.json")
        arena.save_config(path="tests/saved_config/nlp-classroom.json")
    ...
    #     with open("examples/avalon.json", "r") as fp:
    #         config = json.load(fp)
    #     arena = Arena.from_config(config)
    #     arena.launch_gradio()
    #
