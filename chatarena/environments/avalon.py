...
class Avalon(Environment):
    ...
    def reset(self):
        ...
        self._moderator_speak(f"All players now know their roles and all necessary information. Please do not reveal information about your roles to the other players. The first leader is Player {self.current_leader_idx}. Player {self.current_leader_idx}, please propose a team for the first quest. This quest requires {self.quest_sizes[0]} players to finish. You can and should propose yourself as a member of the quest team unless there is a strong reason not to do so. All players, there will be three rounds of discussion before you vote for the proposed team. Please make sure to use the discussions wisely.") 
